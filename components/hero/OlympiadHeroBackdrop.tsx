...
const DIAGRAMS: { pos: string; svg: React.ReactNode }[] = [
  {
    ...
    svg: (
      ...
      >
        ...
        <path
          d="M100 30 c -5 1 -6 6 -6 11 v 34 c 0 5 1 10 6 11"
          opacity="0.8"
        />
      </svg>
    ),
  ...
  },
  {
    ...
    svg: (
      ...
      >
        ...
        {/* layer 3 */}
        <circle cx="120" cy="55" r="5" fill="currentColor" fillOpacity="0.25" />
        {/* connections */}
        <line x1="24" y1="25" x2="66" y2="35" opacity="0.5" />
        <line x1="24" y1="25" x2="66" y2="70" opacity="0.5" />
        <line x1="24" y1="55" x2="66" y2="35" opacity="0.5" />
        <line x1="24" y1="55" x2="66" y2="70" opacity="0.5" />
        <line x1="24" y1="85" x2="66" y2="35" opacity="0.5" />
        <line x1="24" y1="85" x2="66" y2="70" opacity="0.5" />
        <line x1="74" y1="35" x2="115" y2="55" opacity="0.5" />
        <line x1="74" y1="70" x2="115" y2="55" opacity="0.5" />
      </svg>
    ),
  },
  {
    ...
    >
      ...
      >
        ...
        >
          ...
          <circle
            ...
            cy="142"
            r="2"
            fill="rgba(127,220,251,0.8)"
            stroke="none"
            className="hero-motion"
            style={{ animation: "hero-pulse 5s ease-in-out infinite" }}
          />
        </g>
        ...
        >
          ...
          <circle
            ...
            stroke="none"
            className="hero-motion"
            style={{ animation: "hero-pulse 6s ease-in-out -2s infinite" }}
          />
        </g>
        ...
        >
          ...
          <circle
            ...
            stroke="none"
            className="hero-motion"
            style={{ animation: "hero-pulse 4.5s ease-in-out -1s infinite" }}
          />
        </g>
        ...
        >
          ...
          <circle
            ...
            stroke="none"
            className="hero-motion"
            style={{ animation: "hero-pulse 5.5s ease-in-out -3.5s infinite" }}
          />
        </g>
        ...
        return (
          <div
            ...
            className={`absolute hidden md:block transition-all duration-700 ${d.pos} ${
              active
                ? "text-[#28b8f2] opacity-40"
                : "text-[#f3f6fb] opacity-[0.05]"
            }`}
            style={
              active
                ? { filter: "drop-shadow(0 0 14px rgba(40,184,242,0.35))" }
                : undefined
            }
          >
            {d.svg}
      ...
      <div className="absolute left-[2.5%] top-[31%] hidden -rotate-6 opacity-[0.22] lg:block">
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-[8.5px] font-bold uppercase tracking-[0.2em] text-[#f3f6fb]/75">
              Mathematics
            </span>
            <span className="text-[8.5px] uppercase tracking-[0.14em] text-[#8e9db5]/70">
              Set 04
            </span>
          </div>
      ...
      <div className="absolute right-[2.5%] top-[27%] hidden rotate-[5deg] opacity-[0.22] lg:block">
        ...
        >
          ...
          <svg
            viewBox="0 0 150 64"
            className="mt-2 w-full text-[#f3f6fb]/60"
            fill="none"
            stroke="currentColor"
            strokeWidth="1"
          >
          ...
          <p className="mt-2 font-mono text-[10px] text-[#f3f6fb]/70">
            v₀ = 12 m/s · θ = 30°
          </p>
        </div>
      </div>
