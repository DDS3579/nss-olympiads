...
const DEFAULT_ROADMAP: RoadmapStage[] = [
  ...
  },
  {
    ...
    description:
      "Work through past national and international papers by topic. Track which problem types consistently trip you up.",
  },
  {
    stage: "Timed Mocks",
    description:
      "Simulate real exam conditions — full-length, timed, no shortcuts. This is where speed and accuracy start to merge.",
  },
  {
    stage: "Exam-Ready",
    description:
      "Final review of weak areas, light practice only. Trust the preparation — this is peak-taper, not cram time.",
  },
];
...
const baseOlympiads: Olympiad[] = [
  ...
  },
  {
    ...
    modelPapers: [{ title: "Physics Bowl 2025", year: "2025", fileUrl: "#" }],
    roadmap: DEFAULT_ROADMAP,
  },
  {
    slug: "chemistry",
  ...
  },
  {
    ...
    modelPapers: [{ title: "IBO Theory Paper 1", year: "2024", fileUrl: "#" }],
    roadmap: DEFAULT_ROADMAP,
  },
];
